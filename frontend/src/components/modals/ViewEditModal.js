  ...
  return (
    <>
      ...
      <div className={`h-full flex flex-col ${theme === 'dark' ? 'bg-slate-900' : 'bg-gray-50'}`}>
        ...
        <div className={`flex-1 overflow-y-auto p-6 m-4 rounded-lg border-4 shadow-2xl ${theme === 'dark' ? 'bg-slate-800/30 border-blue-500/50 shadow-blue-500/20' : 'bg-white border-blue-500 shadow-blue-500/30'}`}>
          {type === 'appointment' ? (
