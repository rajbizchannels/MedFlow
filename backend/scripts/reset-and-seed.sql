-- AureonCare Database Reset and Seed Script
-- This script removes all legacy data and inserts fresh compatible test data
...
TRUNCATE TABLE telehealth_sessions CASCADE;
