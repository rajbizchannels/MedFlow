...
('20000000-0000-0000-0000-000000000003', (SELECT id FROM claims WHERE claim_no = 'CLM-2024-003'), 100.00, 'credit_card', NOW() - INTERVAL '3 days', 'completed', NOW() - INTERVAL '3 days', NOW());
